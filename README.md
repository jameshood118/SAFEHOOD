...
This repository serves as the command center for the SAFEHOOD protocol. Built on a modern, high-performance stack, it operates as a secure management interface and "Airlock" for processing Peer Node verification, Freehold alignment, biological telemetry, and Zero-Trust Agent Orchestration before any data interacts with external legacy systems.
...
## 🌌 The Matrix (OS Partitions & Bare-Metal Custody)

The Rig is divided into isolated, highly optimized operational zones, anchored strictly to localized hardware:

* **Project Monarch (The Physical Layer)**: The Bare-Metal Custody environment. Houses the Osgood-Rupert physical air-gap, the Orange Pi 5 Plus engine, and Mistral Nemo 12B local weights. Software without hardware custody is just rented infrastructure.
...
* **Work OS (`/personnel`)**: Professional Node tracking. Freehold alignment, Braid connections, and Jinba Ittai alignment meters.
