...
export const TemporalVault = () => {
  ...
  const getOperationIcon = (operation: string) => {
    switch (operation) {
      case 'INSERT':
        return <FontAwesomeIcon icon={faPlus} color="#4CAF50" />;
      case 'UPDATE':
        return <FontAwesomeIcon icon={faPen} color="#FFEB3B" />;
      case 'DELETE':
        return <FontAwesomeIcon icon={faMinus} color="#F44336" />;
      default:
        return <FontAwesomeIcon icon={faDatabase} color="#00E5FF" />;
    }
  };
