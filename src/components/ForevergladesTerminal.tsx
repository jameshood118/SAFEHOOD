  ...
  return (
    <Box component="main" sx={{ minHeight: '100vh', bgcolor: '#0a0510', color: '#00ff41', fontFamily: 'monospace', p: { xs: 2, md: 4 }, position: 'relative' }}>
      <Container maxWidth="lg">
        {/* Header Section */}
        <Box component="header" sx={{ mb: 4, borderBottom: '1px solid #1b5e20', pb: 4 }}>
          <Stack direction="row" spacing={2} alignItems="center">
            <FontAwesomeIcon icon={faTerminal} />
            <Typography variant="h4" component="h1" sx={{ fontWeight: 800 }}>S.A.F.E.H.O.O.D. v2.1 // LOG SEARCH</Typography>
          </Stack>
        </Box>

        {/* The Search & Filter Interface (Environment Optimization) */}
